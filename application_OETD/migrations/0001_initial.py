# Generated by Django 4.2.2 on 2023-07-04 17:31
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('wosrid', models.CharField(max_length=250, null=True, verbose_name='worsrid')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('created_at', models.DateTimeField(null=True, verbose_name='Время создание ')),
                ('updated_at', models.DateTimeField(null=True, verbose_name='Время изменения')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=250, verbose_name='Наименование')),
                ('display_name', models.CharField(choices=[('Преподаватель', 'Преподаватель'), ('Проверяющий', 'Проверяющий'), ('Администратор', 'Администратор')], default='Преподаватель', max_length=250, verbose_name='Название дисплея')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='application_OETD.categories')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('role', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='application_OETD.roles')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('permission', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='application_OETD.permissions')),
                ('role', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='application_OETD.roles')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(null=True, verbose_name='Время создание ')),
                ('updated_at', models.DateTimeField(null=True, verbose_name='Время изменения')),
                ('menu', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='application_OETD.menus')),
            ],
        ),
        migrations.CreateModel(
            name='Forms',
            fields=[
                ...
                ('reporting_period', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='application_OETD.reportingperiods')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('form', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='application_OETD.forms')),
                ('reporting_period', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='application_OETD.reportingperiods')),
            ],
        ),
        migrations.CreateModel(
            name='FormPosition',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('form', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='application_OETD.forms')),
                ('position', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='application_OETD.positions')),
            ],
        ),
        migrations.CreateModel(
            name='FormCategory',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='application_OETD.categories')),
                ('form', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='application_OETD.forms')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.TextField(max_length=250, verbose_name='Наименование')),
                ('description', models.TextField(max_length=250, verbose_name='Описание')),
                ('file_category', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='application_OETD.filescatigories')),
                ('user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.AddField(
            model_name='fields',
            name='form',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='application_OETD.forms'),
        ),
        migrations.AddField(
            model_name='fields',
            name='inspector',
