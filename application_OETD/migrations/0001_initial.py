# Generated by Django 4.2.2 on 2023-07-15 07:44
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('start_filling', models.DateField(verbose_name='Начало заполнения')),
                ('end_filling', models.DateField(verbose_name='Конец заполнения')),
                ('start_checking', models.DateField(verbose_name='Начало проверки')),
                ('end_checking', models.DateField(verbose_name='Конец проверки')),
            ],
            options={
